...
const RECOMMENDED_QUERIES = [
  ...
  '"nobody fills out my contact form"',
  ...
  '"my clinic needs a website"',
  '"real estate website" (help OR redesign)',
  '"my online store looks bad"',
  '"ecommerce store" ("losing sales" OR "not converting")',
];
